...
public class ProductionRequestService {
    ...
    // Get all requests
    public List<ProductionRequest> getAllRequests() {
        return productionRequestRepository.findAll();
    }

    // Get requests by user
    public List<ProductionRequest> getMyRequests(
            Long userId) {
    ...
    // Create new request
    public ProductionRequest createRequest(
            Long itemId, Integer quantity,
            Long requestedById, String notes) {
        ...
        if (item.getItemType() != Item.ItemType.FINISHED_GOOD) {
            throw new RuntimeException(
                "Production requests can only be " +
                "created for Finished Goods");
        }
    ...
    // Approve request
    public ProductionRequest approveRequest(
    ...
    // Reject request
    public ProductionRequest rejectRequest(
            Long requestId, Long managerId,
            String reason) {
